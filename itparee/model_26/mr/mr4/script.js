document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = [
        { img: "data/image/1.png", correct: [0, 4] }, // A and D
        { img: "data/image/2.png", correct: [1, 3] }, // B and E
        { img: "data/image/3.png", correct: [0, 2] },  // C and D
        { img: "data/image/4.png", correct: [2, 4] },
        { img: "data/image/5.png", correct: [0, 1] },
        { img: "data/image/6.png", correct: [1, 2] },
        { img: "data/image/7.png", correct: [0, 4] },
        { img: "data/image/8.png", correct: [2, 3] },
        { img: "data/image/9.png", correct: [0, 4] },
        { img: "data/image/10.png", correct: [1, 2] },
        { img: "data/image/11.png", correct: [3, 4] },
        { img: "data/image/12.png", correct: [0, 4] },
        { img: "data/image/13.png", correct: [0, 4] },
        { img: "data/image/14.png", correct: [0, 3] },
        { img: "data/image/15.png", correct: [1, 2] },
        { img: "data/image/16.png", correct: [0, 2] },
        { img: "data/image/17.png", correct: [2, 3] },
        { img: "data/image/18.png", correct: [2, 4] },
        { img: "data/image/19.png", correct: [0, 3] },
        { img: "data/image/20.png", correct: [2, 3] },
        { img: "data/image/21.png", correct: [1, 2] },
        { img: "data/image/22.png", correct: [1, 4] },
        { img: "data/image/23.png", correct: [1, 4] },
        { img: "data/image/24.png", correct: [0, 4] },
        { img: "data/image/25.png", correct: [1, 2] }
