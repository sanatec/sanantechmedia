document.addEventListener('DOMContentLoaded', () => {
  ...
  },
  {
    ...
    "options": [
      { "text": "Restart Scribus", "isCorrect": false },
      { "text": "Convert to shape", "isCorrect": false },
      { "text": "Select proper Unicode font and language", "isCorrect": true },
      { "text": "Delete the text", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Page size and margins", "isCorrect": true },
  ...
  },
  {
    ...
    "options": [
      { "text": "Tools menu only", "isCorrect": false },
      { "text": "By double-clicking an object or from the Windows menu", "isCorrect": true },
      { "text": "Insert menu", "isCorrect": false },
      { "text": "Format menu", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Makes the line curved", "isCorrect": false },
      { "text": "Creates a dashed line", "isCorrect": false },
      { "text": "Ensures the line is perfectly straight", "isCorrect": true },
      { "text": "Activates shadow", "isCorrect": false }
    ]
  },
  {
    "question": "What does the Selection Tool allow you to do in Scribus?",
    "options": [
      { "text": "Add new text", "isCorrect": false },
      { "text": "Import fonts", "isCorrect": false },
      { "text": "Move and resize objects", "isCorrect": true },
      { "text": "Export documents", "isCorrect": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "Opens color settings only", "isCorrect": false },
      { "text": "Opens context menu with editing options", "isCorrect": true },
      { "text": "Activates Node Editing", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Use Shadow Tool", "isCorrect": false },
      { "text": "Apply drop shadow in Text Effects", "isCorrect": false },
      { "text": "Enable “Has Drop Shadow” in Properties", "isCorrect": true },
      { "text": "Convert to 3D", "isCorrect": false }
    ]
  },
  {
