document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = [
  {
    ...
    "options": [
      { "text": "Connect USB cable", "isCorrect": false },
      { "text": "Upload Firmware", "isCorrect": true },
      { "text": "Press RESET", "isCorrect": false },
      { "text": "Close PictoBlox", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Signal", "isCorrect": false },
      { "text": "Ground potential (0V)", "isCorrect": true }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Upload Mode", "isCorrect": false },
      { "text": "Debug Mode", "isCorrect": false },
      { "text": "Stage Mode", "isCorrect": true },
      { "text": "Compile Mode", "isCorrect": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "Collect and send signals", "isCorrect": true },
      { "text": "Camera connection", "isCorrect": false }
    ]
  },
  {
    "question": "Which wire of the servo motor is used to receive control signals?",
    "options": [
      { "text": "Red wire", "isCorrect": false },
      { "text": "Brown wire", "isCorrect": false },
      { "text": "Orange wire", "isCorrect": true },
      { "text": "Black wire", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Shorter than the cathode", "isCorrect": false },
      { "text": "Equal in length to the cathode", "isCorrect": false },
      { "text": "Longer than the cathode", "isCorrect": true },
      { "text": "Located in the center", "isCorrect": false }
    ]
  },
  {
    "question": "What type of signal is used to control a servo motor?",
    "options": [
      { "text": "Analog voltage", "isCorrect": false },
      { "text": "PWM signal", "isCorrect": true },
      { "text": "Audio signal", "isCorrect": false },
      { "text": "Serial signal", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "IR Sensor", "isCorrect": false },
      { "text": "Camera", "isCorrect": false },
      { "text": "Light Sensor", "isCorrect": true },
  ...
  },
  {
    ...
    "options": [
      { "text": "HDMI ports", "isCorrect": false },
      { "text": "DIGITAL I/O PINs", "isCorrect": true },
      { "text": "WiFi", "isCorrect": false },
      { "text": "Serial cable", "isCorrect": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "Microcontroller", "isCorrect": true },
