document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = [
  {
    ...
    "options": [
      { "text": "Its OUT pin becomes HIGH", "isCorrect": false },
      { "text": "Its OUT pin becomes LOW", "isCorrect": true },
      { "text": "It vibrates", "isCorrect": false },
      { "text": "It lights up", "isCorrect": false }
    ]
  },
  {
    "question": "Which of these is NOT a programming block in PictoBlox?",
    "options": [
      { "text": "Upload Firmware", "isCorrect": false },
  ...
  },
  {
    ...
    "options": [
      { "text": "1 and 0 respectively", "isCorrect": false },
      { "text": "0 and 1 respectively", "isCorrect": false },
      { "text": "True and False respectively", "isCorrect": false },
  ...
  },
  {
    ...
    "options": [
      { "text": "By power pin", "isCorrect": false },
      { "text": "By changing delay in code", "isCorrect": true },
      { "text": "By using resistor", "isCorrect": false },
      { "text": "By rotating the LED", "isCorrect": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "Power boost", "isCorrect": false },
      { "text": "Analog signal control through digital pins", "isCorrect": true },
      { "text": "Memory access", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Connect USB", "isCorrect": false },
      { "text": "Control power supply", "isCorrect": false },
      { "text": "Control servo motor (PWM)", "isCorrect": true },
      { "text": "Run the microcontroller", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "It is made by Microsoft", "isCorrect": false },
      { "text": "Its code and schematics are publicly available", "isCorrect": true },
      { "text": "It can be purchased freely", "isCorrect": false },
      { "text": "It uses only open circuits", "isCorrect": false }
    ]
  },
  {
    ...
    "options": [
      ...
      { "text": "USB Port", "isCorrect": false },
      { "text": "Built-in camera", "isCorrect": true },
      { "text": "Microcontroller chip", "isCorrect": false }
    ]
  },
  {
    "question": "The blinking of an LED is an example of:",
    "options": [
      { "text": "Digital Output", "isCorrect": true },
      { "text": "Digital Input", "isCorrect": false },
      { "text": "Analog Input", "isCorrect": false },
      { "text": "Serial Communication", "isCorrect": false }
    ]
  },
  {
    "question": "Which of these actions requires writing a program to the Arduino?",
    "options": [
      { "text": "Powering an LED", "isCorrect": false },
      { "text": "Making a buzzer beep at intervals", "isCorrect": true },
      { "text": "Plugging USB", "isCorrect": false },
      { "text": "Mounting on breadboard", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Rotate to 90°", "isCorrect": false },
      { "text": "Vibrate", "isCorrect": false },
      { "text": "Rotate to 0°", "isCorrect": true },
      { "text": "Turn off", "isCorrect": false }
    ]
  },
  {
    "question": "Which of the following devices functions without a physical button using a sensor?",
    "options": [
      { "text": "Traditional tap", "isCorrect": false },
      { "text": "Automatic door", "isCorrect": true },
      { "text": "Hand pump", "isCorrect": false },
      { "text": "Bicycle bell", "isCorrect": false }
    ]
  },
  {
    "question": "What happens when you increase the delay time in the LED blinking program?",
    "options": [
      { "text": "LED blinks faster", "isCorrect": false },
      { "text": "LED stops blinking", "isCorrect": false },
      { "text": "LED blinks slower", "isCorrect": true },
      { "text": "LED glows continuously", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Provides internet", "isCorrect": false },
      { "text": "Powers the sensor", "isCorrect": false },
      { "text": "Transfers programs and power", "isCorrect": true },
      { "text": "Cools down components", "isCorrect": false }
    ]
  } 
    ];
