document.addEventListener('DOMContentLoaded', () => {
  ...
  },
  {
    ...
    "options": [
      { "text": "The page loads faster", "isCorrect": false },
      { "text": "Code size increases", "isCorrect": true },
      { "text": "Code becomes cleaner", "isCorrect": false },
  ...
  },
  {
    ...
    "options": [
      { "text": "Code becomes complex", "isCorrect": false },
      { "text": "Repetition of styles", "isCorrect": false },
      { "text": "Easier maintenance", "isCorrect": true },
      { "text": "Larger code size", "isCorrect": false }
    ]
  },
  {
    "question": "What is a selector in CSS?",
    "options": [
      { "text": "A style tag", "isCorrect": false },
      { "text": "An HTML attribute", "isCorrect": false },
      { "text": "An element to which styles are applied", "isCorrect": true },
      { "text": "A script function", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Inside the <head> within <style> tags", "isCorrect": true },
      { "text": "Inside <body> using <div>", "isCorrect": false },
      { "text": "In an external file", "isCorrect": false },
  ...
  },
  {
    ...
    "options": [
      { "text": "To apply style to JavaScript", "isCorrect": false },
      { "text": "To group paragraphs", "isCorrect": false },
      { "text": "To apply styles to specific elements with the same class", "isCorrect": true },
      { "text": "To insert images", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Stylesheets", "isCorrect": true },
      { "text": "IDs only", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Inline CSS", "isCorrect": false },
      { "text": "Internal CSS", "isCorrect": false },
      { "text": "External CSS", "isCorrect": true },
      { "text": "HTML styling", "isCorrect": false }
    ]
  },
  {
    "question": "What is the advantage of external CSS?",
    "options": [
      { "text": "More lines of code", "isCorrect": false },
      { "text": "Code duplication", "isCorrect": false },
      { "text": "Single change affects all pages", "isCorrect": true },
      { "text": "Must be written for every tag", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "The selector", "isCorrect": false },
      { "text": "The property", "isCorrect": false },
      { "text": "The declaration block", "isCorrect": true },
      { "text": "The tag", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      { "text": "Changes color", "isCorrect": false },
      { "text": "Sets text alignment", "isCorrect": false },
      { "text": "Sets size of the font", "isCorrect": true },
      { "text": "Changes background", "isCorrect": false }
    ]
  },
  {
