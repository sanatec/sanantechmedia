document.addEventListener('DOMContentLoaded', () => {
  ...
  },
  {
    ...
    "options": [
      { "text": "External > Internal > Inline", "isCorrect": false },
      { "text": "Inline > Internal > External", "isCorrect": true },
      { "text": "Internal > External > Inline", "isCorrect": false },
      { "text": "Inline > External > Internal", "isCorrect": false }
    ]
  },
  {
    "question": "The main benefit of using CSS is:",
    "options": [
      { "text": "Use fewer tags", "isCorrect": false },
      { "text": "Add more HTML", "isCorrect": false },
      { "text": "Improve styling and reduce code duplication", "isCorrect": true },
      { "text": "Increase file size", "isCorrect": false }
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      ...
      { "text": "Using external link in <head>", "isCorrect": true },
  ...
  },
  {
    ...
    "options": [
      { "text": "id uses #, class uses .", "isCorrect": true },
      { "text": "class uses #, id uses .", "isCorrect": false },
      { "text": "both use #", "isCorrect": false },
      { "text": "both use .", "isCorrect": false }
    ]
  },
  {
