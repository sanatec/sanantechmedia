document.addEventListener('DOMContentLoaded', () => {
    ...
    const quizData = [
    {
        "question": "What is the main purpose of software publishing?",
        "options": [
          { "text": "To make software available for others to use", "isCorrect": true },
          { "text": "To create hardware", "isCorrect": false },
          { "text": "To remove licenses", "isCorrect": false },
          { "text": "To encrypt data", "isCorrect": false }
        ],
        "correctAnswer": "To make software available for others to use"
      },
      {
        "question": "Which of these is not a publishing platform?",
        "options": [
      ...
      {
        "question": "Term for modifying existing free software?",
        "options": [
          { "text": "Forking", "isCorrect": true },
          { "text": "Encoding", "isCorrect": false },
          { "text": "Installing", "isCorrect": false },
          { "text": "Debugging", "isCorrect": false }
        ],
        "correctAnswer": "Forking"
      },
      {
        "question": "Example of version control system?",
        "options": [
      ...
      {
        "question": "Most restrictive software license?",
        "options": [
      ...
      {
        "question": "Software under GPL license?",
        "options": [
      ...
      {
        "question": "Unauthorized copying of code is called ?",
        "options": [
      ...
      {
        "question": "When was Unix developed?",
        "options": [
        ...
        "correctAnswer": "1969–70"
      },
      {
        "question": "Who developed Linux kernel?",
        "options": [
      ...
      {
        "question": "Which is an open-source license?",
        "options": [
      ...
      {
        "question": "Role of kernel in OS?",
        "options": [
          { "text": "Interact with hardware", "isCorrect": true },
          { "text": "Display GUI", "isCorrect": false },
          { "text": "Manage storage", "isCorrect": false },
          { "text": "Run applications", "isCorrect": false }
        ],
        "correctAnswer": "Interact with hardware"
      },
      {
        "question": "Role of shell in OS?",
        "options": [
          { "text": "Interact with user", "isCorrect": true },
          { "text": "Compile programs", "isCorrect": false },
          { "text": "Manage memory", "isCorrect": false },
          { "text": "Encrypt data", "isCorrect": false }
        ],
        "correctAnswer": "Interact with user"
      },
      {
        "question": "Example of GNU/Linux distribution?",
        "options": [
      ...
      {
        "question": "Organization that developed Apache Subversion?",
        "options": [
        ...
        "correctAnswer": "Apache Software Foundation"
      },
      {
        "question": "Android is based on?",
        "options": [
      ...
      {
        "question": "License that allows redistribution with conditions?",
        "options": [
      ...
      {
        "question": "Software distributed only as object code?",
        "options": [
          { "text": "Proprietary Software", "isCorrect": true },
          { "text": "Open Source Software", "isCorrect": false },
      ...
      {
        "question": "Advantage of open source software?",
        "options": [
          { "text": "Allows collaboration and learning", "isCorrect": true },
          { "text": "Hidden source code", "isCorrect": false },
          { "text": "Limited access", "isCorrect": false },
          { "text": "High license fees", "isCorrect": false }
        ],
        "correctAnswer": "Allows collaboration and learning"
      }   
    ];
